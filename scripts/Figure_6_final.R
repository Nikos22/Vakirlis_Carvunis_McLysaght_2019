...
cer_gp_tbl <- read.csv("scripts_submission/final_scripts/cer_genePairs_df.csv",
         as.is=TRUE,
         stringsAsFactors = FALSE)

dros_gp_tbl <- read.csv("scripts_submission/final_scripts/dros_genePairs_df.csv",
                       as.is=TRUE,
                       stringsAsFactors = FALSE)
...
vert_gp_tbl <- read.csv("scripts_submission/final_scripts/vert_genePairs_df.csv",
                        as.is=TRUE,
                        stringsAsFactors = FALSE)
...
cer_nr <- read.table("scripts_submission/nr_results/yeast_001_prot_vs_nr_noSC_clean.out",
                     stringsAsFactors = FALSE,
                     fill=TRUE,
                     row.names=NULL,
                     header=FALSE,
...
dros_nr <- read.table("scripts_submission/nr_results/dros_001_prot_vs_nr_noDM_clean_noU.out",
                      stringsAsFactors = FALSE,
                      fill=TRUE,
                      row.names=NULL,
                      header=FALSE,
...
vert_nr <- read.table("scripts_submission/nr_results/human_0001_prot_vs_nr_noHS_clean_noU.out",
                      stringsAsFactors = FALSE,
                      fill=TRUE,
                      row.names=NULL,
                      header=FALSE,
...
cer_focal_pfam <- read.table("scripts_submission/Pfam_results/yeast_001_prot_vs_pfam.txt",
                             header=TRUE,
                             stringsAsFactors = FALSE,
                             row.names=NULL,
                             fill=TRUE)
colnames(cer_focal_pfam) <- c(c("Gene_focal"), colnames(cer_focal_pfam)[2:15])
cer_ortho_pfam <- read.table("scripts_submission/Pfam_results/yeast_target_001_prot_vs_pfam.txt",
                             header=TRUE,
                             stringsAsFactors = FALSE,
                             row.names=NULL,
                             fill=TRUE)
...
dros_focal_pfam <- read.table("scripts_submission/Pfam_results/dros_001_prot_u_vs_pfam_noU.txt",
                              header=TRUE,
                              stringsAsFactors = FALSE,
                              row.names=NULL,
                              fill=TRUE)
colnames(dros_focal_pfam) <- c(c("Gene_focal"), colnames(dros_focal_pfam)[2:15])
dros_ortho_pfam <- read.table("scripts_submission/Pfam_results/dros_target_001_prot_u_vs_pfam_noU.txt",
                              header=TRUE,
                              stringsAsFactors = FALSE,
                              row.names=NULL,
                              fill=TRUE)
...
vert_focal_pfam <- read.table("scripts_submission/Pfam_results/human_0001_prot_u_vs_pfam_noU.txt",
                              header=TRUE,
                              stringsAsFactors = FALSE,
                              row.names=NULL,
                              fill=TRUE)
colnames(vert_focal_pfam) <- c(c("Gene_focal"), colnames(vert_focal_pfam)[2:15])
vert_ortho_pfam <- read.table("scripts_submission/Pfam_results/additional_ortho_gotten_prot_vs_pfam.txt",
                              header=TRUE,
                              stringsAsFactors = FALSE,
                              row.names=NULL,
                              fill=TRUE)
...
write.csv(all_main_df, "scripts_submission/final_scripts/Figure_5_data.csv", row.names = FALSE)
...
write.csv(all_raw_df, "scripts_submission/final_scripts/Figure_5_stats_data.csv", row.names = FALSE)
...
ggsave("scripts_submission/final_scripts/Figure5A.pdf")
...
ggsave("scripts_submission/final_scripts/Figure5B.pdf")
...
write.csv(sup_table_3, "scripts_submission/final_scripts/Supp_table_3.csv", row.names=FALSE)
...
write.csv(df_gathered_cp, "scripts_submission/final_scripts/Supp_table_CDS_length_SS_comparison.csv", col.names = FALSE)
...
ggsave("scripts_submission/final_scripts/Figure6B.pdf")
...
cer_prot_gene_names <- read.table("scripts_submission/dnds/gene_prot_names.txt")

cer_dnds <- read.table("scripts_submission/dnds/scer_dn_ds.txt",
                       header=FALSE,
                       stringsAsFactors = FALSE)
dros_dnds <- read.table("scripts_submission/dnds/Dmel_Dsim_analysis_results_flydivas_v1.2.txt",
                        header=TRUE,
                        stringsAsFactors = FALSE)
vert_dnds <- read.table("scripts_submission/dnds/human_mouse_dnds.tsv",
                        header=TRUE,
                        stringsAsFactors = FALSE,
                        sep='\t')
...
colnames(cer_dnds) <- c("Gene_name","dN", "dS", "inTrip", "tag")
colnames(vert_dnds) <- c("Gene_name", "dN", "dS", "inTrip", "tag")
colnames(dros_dnds) <- c("Gene_name", "dN", "dS", "inTrip", "tag")
...
write.csv(df_all, file="scripts_submission/final_scripts/Supp_figure_4_data.csv", row.names = FALSE)
colnames(df_all) <- c("Gene_name","dN","dS","inTrip","tag","dNdS")

# added cliff's delta effect size as well.
...
write.csv(dnds_stats, file="scripts_submission/final_scripts/Supp_figure_4_stats_table_full.csv", row.names = FALSE)

box_dn <- ggplot() +
  geom_boxplot(data = df_all, 
               aes(x=inTrip, 
                   y=dN,
                   fill=tag),
               notch = TRUE,
...
box_dnds <- ggplot() +
  ...
  facet_grid(~tag) +
  xlab("Conserved micro-synteny") +
  ylab("dN/dS")

pl <- grid.arrange(box_dn, box_ds, box_dnds,  ncol=1)

ggsave(plot = pl, "scripts_submission/final_scripts/Supp_figure_4.png", width=7, height=12)
...
ggsave(plot = dens_dn_ds, "scripts_submission/final_scripts/New_figure_4.pdf")